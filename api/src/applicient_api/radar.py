...
async def run_radar_search(
    ...
    with session_factory() as db:
        ...
        if touched_job_ids:
            ...
            # profile_revision) pair — M1 §5 wants a new score
            # appended "when the profile or persona changes," which
            # implies the inverse too: a rerun against an unchanged
            # profile shouldn't re-pay for the same score.
            already_scored_ids = {
                row[0]
